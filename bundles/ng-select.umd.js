...
var SelectComponent = (function () {
    ...
    function SelectComponent(hostElement, changeDetectorRef) {
        ...
        this._value = [];
        this.optionList = new OptionList([], this.showSelected);
        // View state variables.
        this.hasFocus = false;
        this.isOpen = false;
        this.isBelow = true;
        this.deselectOptionEmitter = new core.EventEmitter();
    ...
    SelectComponent.prototype.onMultipleFilterInput = function (term) {
        var _this = this;
        this.filter(term, function () { return _this.search.emit(term); });
    };
    /**
     * @param {?} event
     * @return {?}
...
SelectComponent.propDecorators = {
    ...
    'selectionTemplate': [{ type: core.ContentChild, args: ['selectionTemplate',] },],
    'clearMultipleTemplate': [{ type: core.ContentChild, args: ['clearMultipleTemplate',] },],
